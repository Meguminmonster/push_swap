...
// Finds the highest index currently present in the stack.
...
// Pushes the top element from one stack to the top of the other (pa/pb)
...
// Algorithm to sort a stack of 3 elements.
